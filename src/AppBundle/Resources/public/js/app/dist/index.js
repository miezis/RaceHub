...
/***/ function(module, exports, __webpack_require__) {
	...
	var testModule = __webpack_require__(168);
	...
	_reactDom2.default.render(_react2.default.createElement(HelloMessage, { name: 'John' }), document.getElementById('my-placeholder'));
...
/***/ function(module, exports) {
	...
	var modulis = {
	    test: 'test string',
	    printTest: function printTest(message) {
	        if (message) {
	            console.log(message);
	            return;
	        }
